...
module.exports = class {
  ...
  constructor( config ) {
    ...
    this.apiUrl = 'https://translate.googleapis.com';
  }
  ...
  translate( queryObj ) {
    return new Promise( ( resolve , reject )=> {
      request
        .get( this.apiUrl + '/translate_a/single' )
        .query( {
          client : 'gtx' ,
          sl : 'auto' , // 源语言
  ...
  audio( queryObj ) {
    return this.detect( queryObj )
      .then( ( lang )=> {
        return encodeURI( `https://translate.googleapis.com/translate_tts?ie=UTF-8&q=${queryObj.text}&tl=${lang}&client=gtx` );
      } );
  }
};
